        ...
        <div className="flex flex-col sm:flex-row gap-6 items-start">
          <div className="relative shrink-0 mx-auto sm:mx-0">
            <div 
              ...
              className={`relative w-36 h-44 rounded-3xl border-2 transition-all duration-500 overflow-hidden flex items-center justify-center cursor-pointer shadow-inner group/photo ${voter.aadharPhoto ? 'border-indigo-100 ring-4 ring-indigo-50/50' : 'border-dashed border-slate-200 bg-slate-50'}`}
            >
              {voter.aadharPhoto ? (
                <>
                  <img src={voter.aadharPhoto} alt="Aadhar" className="w-full h-full object-cover group-hover/photo:scale-110 transition-transform duration-700" />
